...
NAV_WIN_NODES = 200           # окно матчинга: ±узлов вокруг последнего; 0 = весь банк (медленно на больших картах)
...
LOOKAHEAD_ADAPT = 3.0         # на сколько узлов укорачивать упреждение на ед. бокового смещения
