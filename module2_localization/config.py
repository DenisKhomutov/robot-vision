...
LOOKAHEAD_NODES = 30           # проверено на улице: меньше срезает повороты, чем прежние 30 узлов
LOOKAHEAD_MIN = 10              # минимальное упреждение при заметном отклонении от маршрута
LOOKAHEAD_ADAPT = 3.0         # сокращение упреждения на ед. бокового смещения (зависит от масштаба карты)
