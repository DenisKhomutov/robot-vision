...
маршрута загружается полная recovery-карта. После `СТАРТ` первый успешный глобальный
фикс выбирает и загружает соответствующий шард. Следующий шард предзагружается во
время движения.
